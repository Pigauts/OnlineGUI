...
public class Sounds {
  ...
  public static void playSound(Player player, MySound mySound, float volume, float pitch) {
    try {
      player.playSound(player.getLocation(), mySound.get(), volume, pitch);
    } catch (Exception monke) {}
  }
